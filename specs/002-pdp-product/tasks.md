...
- [X] T103 [US1] 创建工作空间治理 Mapper、XML 和数据库适配器，文件：`modules/public-persistence/src/main/java/com/pdp/persistence/workspace/`、`modules/public-persistence/src/main/resources/mapper/workspace/`
