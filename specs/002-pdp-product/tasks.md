...
- [ ] T103 [US1] 创建工作空间治理 MySQL Mapper、XML 和适配器，文件：`modules/persistence-mysql/src/main/java/com/pdp/mysql/workspace/`、`modules/persistence-mysql/src/main/resources/mapper/workspace/`
