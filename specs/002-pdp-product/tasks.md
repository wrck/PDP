...
- [x] T119 [US2] 创建领域包 Mapper、XML 和数据库适配器，文件：`modules/public-persistence/src/main/java/com/pdp/persistence/domainconfig/`、`modules/public-persistence/src/main/resources/mapper/domainconfig/`
