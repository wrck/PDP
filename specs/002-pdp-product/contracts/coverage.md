...
| US8 审批 | 审批发起与动作接口 | 审批终态事件 | Web、业务模块、通知 | 节点、轮次、撤权、幂等和回写 |
| US9 多视图 | 项目查询和保存视图接口 | 无新增权威状态事件 | Web | 权限、排序、跨视图和可访问性测试 |
...
| US21 多数据库 | 当前部署、认证和数据库切换接口 | `migration-report.schema.json`、切换事件 | 运维控制台、迁移器 | 双数据库语义、单写和双向切换 |
